...
!!! note "Note"
    It's important that a model doesn't change the size of the population it's being applied to. If not the size of the population will diverge to $\infty$ or converge to 0.
